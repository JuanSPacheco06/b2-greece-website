...
st.set_page_config(
    page_title="Places to visit | Greek Escape",
    page_icon="📷",
    layout="wide"
)
...
<div class="page-header">
    <h1 style="font-size: 3.5rem; margin-bottom: 1rem;">⛰️ Discover Greece</h1>
    <p style="font-size: 1.3rem; opacity: 0.9;">A visual journey through its most breathtaking destinations</p>
</div>
""", unsafe_allow_html=True)
